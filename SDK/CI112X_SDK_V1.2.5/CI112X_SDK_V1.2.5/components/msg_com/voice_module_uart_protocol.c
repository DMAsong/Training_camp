...
#if USE_IIS_ASR_FUN
    case VMUP_MSG_CMD_IIS1_SLAVE_ASR:
    { //进入IIS1 slave模式识别
        vTaskDelay(pdMS_TO_TICKS(200));
        change_audio_in_to_outside_iis();
        break;
    }
#endif
#if OTA_ENABLE
