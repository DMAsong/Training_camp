...
#if 0
#if 1
#define FRAME_SIZE      (512) //ALG_FRAME  
#define FRAME_SHIFT      256 
#define FRM_FFT_LENTH   (512)
#define FFT_SIZE         256  
#define ALG_FRAME_SIZE (256)//16ms

#else

#define FRAME_SIZE           (400) //ALG_FRAME 
#define FRAME_SHIFT 160 

#define FRM_FFT_LENTH   (512)
#define FFT_SIZE    256   

#define ALG_FRAME_SIZE (160)//10ms
#endif
#endif

#if 1//32k
#if 0
#define FRAME_SIZE      (1024) //ALG_FRAME  
#define FRAME_SHIFT      512 
#define FRM_FFT_LENTH   (1024)
#define FFT_SIZE         512  
#define ALG_FRAME_SIZE (512)//16ms

#else

#define FRAME_SIZE           (800) //ALG_FRAME 
#define FRAME_SHIFT 320 

#define FRM_FFT_LENTH   (1024)
#define FFT_SIZE    512   

#define ALG_FRAME_SIZE (320)//10ms
#endif
#endif

#define USE_IFFT (0)//
#define USE_FFT_FUN (0)
