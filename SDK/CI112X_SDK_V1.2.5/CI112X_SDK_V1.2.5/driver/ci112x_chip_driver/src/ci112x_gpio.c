 ...
 * @brief 管脚配置为输出模式
 *
 * @param base :GPIO0 GPIO1 GPIO2 GPIO3 GPIO4
 * @param pins :gpio_pin_0,gpio_pin_1...gpio_pin_7,gpio_pin_all;中的一个或多个
 */
 ...
 *
 * @param base :GPIO0 GPIO1 GPIO2 GPIO3 GPIO4
 * @param pins :gpio_pin_0,gpio_pin_1...gpio_pin_7;中的一个
 *
...
void registe_gpio_callback(gpio_base_t base, gpio_irq_callback_list_t *gpio_irq_callback_node)
{
    switch (base)
    {
        case GPIO4:
        {
            gpio_callback_add_node_in_list(&g_gpio_callback_list_root[4], gpio_irq_callback_node);
            break;
        }
        case GPIO3:
        {
            gpio_callback_add_node_in_list(&g_gpio_callback_list_root[3], gpio_irq_callback_node);
            break;
        }
        case GPIO2:
        {
